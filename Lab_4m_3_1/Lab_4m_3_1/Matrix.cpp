...
void MatriX::initSize(int m_, int n_)
{
	m = m_;
	n = n_;
...
void MatriX_Quad::initSize(int m_)
{
	m = m_;
	n = m_;
...
void MatriX_Vector::initSize(int m_)
{
	m = m_;
	n = 1;
...
MatriX MatriX_Vector::operator *(MatriX &M)
{
	return MatriX::operator*(M);
}
